...
public class PizzaService : IPizzaService
{
    ...
    public async Task<ServiceResponse> UpdatePizza(CreatePizzaViewModel pizza)
    {
        // Поскольку CreatePizzaViewModel не соответствует Pizza структуре сущности,
        // прямое использование SetValuesздесь не сработает. Вместо этого следует обновить
        // каждое свойство вручную, включая обработку отношения «многие ко многим» для ингредиентов.
        ...
        if (existingPizza == null)
            return ServiceResponse.FailureResponse("Pizza not found.");
        ...
        // Очистка текущих ингредиентов и добавление новых
